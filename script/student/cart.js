...
function validatePromoCode(code, items = []) {
  ...
  const currentEmail =
    sessionStorage.getItem("studentEmail") || "vaughn.student@wm.edu.ph";
  ...
  if (vendorPromo) {
    ...
    if (vendorPromo.validFrom) {
      const startDate = new Date(vendorPromo.validFrom);
    ...
    // 3. Check expiry date
    if (vendorPromo.expiry) {
      const expiryDate = new Date(vendorPromo.expiry);
    ...
    return {
      type: vendorPromo.type,
      value:
        vendorPromo.type === "percent"
          ? vendorPromo.value / 100
          : vendorPromo.value,
      label:
        vendorPromo.type === "percent"
          ? `${vendorPromo.value}% Off`
          : `₱${vendorPromo.value} Off`,
      vendor: vendorPromo.vendor,
      appliesTo: vendorPromo.appliesTo || "all",
    };
  }
 ...
 */
function placeOrder(instructions, payment, promoCode = null) {
  ...
  Object.keys(groups).forEach((vendor, index) => {
    ...
    const customerName = document.querySelector(".profile-name")?.textContent?.trim() || 
                        ...
                        sessionStorage.getItem("outsiderName") || 
                        "Customer";
      ...
      if (typeof updateWalletBalance === "function") {
        ...
        if (typeof addWalletTransaction === "function") {
          addWalletTransaction(
            `Payment - Order #${orderId.slice(-6).toUpperCase()}`,
            order.total,
            false,
            "payment",
          );
  ...
  if (order) {
    ...
    if (order.isPaid && !prevIsPaid) {
      if (typeof updateWalletBalance === "function") {
        ...
        if (typeof addWalletTransaction === "function") {
          addWalletTransaction(
            `Payment - Order #${order.id.slice(-6).toUpperCase()}`,
            order.total,
            false,
            "payment",
          );
    ...
    if (prevStatus !== status) {
      if (
        status === "preparing" &&
        typeof notifyOrderPreparing === "function"
      ) {
        ...
        status === "cancelled" &&
        typeof notifyOrderCancelled === "function"
      ) {
...
function removeOrder(orderId, role = "student") {
  ...
  const finalOrders = orders.filter(
    (o) => !(o.removedByStudent && o.removedByVendor),
  );
...
function initDefaultMenu() {
  ...
  const defaults = [
    ...
    {
      id: "burger|mang_tinos_canteen",
      name: "Burger",
      price: 30,
      category: "meals",
      badge: "popular",
      rating: 4.5,
      vendor: "Mang Tino's Canteen",
      shopId: 1,
      prepTime: "8 min",
      stock: 15,
      available: true,
      ...
      reviews: [
        {
          name: "Ana R.",
          stars: 5,
          comment: "Best burger on campus! Always fresh.",
        },
        {
          name: "Mark T.",
          stars: 4,
          comment: "Great taste, a bit small for the price.",
        },
      ],
    },
    {
      id: "shomai_rice|mang_tinos_canteen",
      name: "Shomai Rice",
      price: 20,
      category: "meals",
      badge: "",
      ...
      reviews: [
        {
          name: "Lisa M.",
          stars: 5,
          comment: "Absolutely love this! Perfect comfort food.",
        },
        {
          name: "Jake P.",
          stars: 5,
          comment: "Worth every peso. Filling and delicious.",
        },
      ],
    },
    {
      id: "hotdog_with_bun|mang_tinos_canteen",
      ...
      reviews: [
        {
          name: "Joy C.",
          stars: 5,
          comment: "Sulit at masarap! Perfect for merienda too.",
        },
      ],
    },
    {
      id: "pancit|mang_tinos_canteen",
      name: "Pancit",
      price: 40,
      category: "meals",
      badge: "",
      ...
      reviews: [
        {
          name: "Ben A.",
          stars: 4,
          comment: "Generous serving, mapait kaunti pero okay.",
        },
      ],
    },
    ...
    {
      id: "shomai|street_bites_corner",
      name: "Shomai",
      price: 15,
      category: "snacks",
      badge: "new",
      rating: 4.7,
      vendor: "Street Bites Corner",
      shopId: 2,
      prepTime: "6 min",
      stock: 30,
      available: true,
      ...
      reviews: [
        { name: "Carla S.", stars: 5, comment: "Mapapa wow ka sa sarap!" },
      ],
    },
    {
      id: "fries|street_bites_corner",
      name: "Fries",
      price: 25,
      category: "snacks",
      badge: "",
      ...
      reviews: [
        {
          name: "Ken A.",
          stars: 5,
          comment: "Always crispy. Never disappoints!",
        },
      ],
    },
    {
      id: "kwek-kwek|street_bites_corner",
      name: "Kwek-Kwek",
      price: 15,
      category: "snacks",
      badge: "popular",
      ...
      reviews: [
        { name: "Pau L.", stars: 4, comment: "Masarap lalo na yung sawsawan." },
      ],
    },
    {
      id: "chips|street_bites_corner",
      name: "Chips",
      price: 20,
      category: "snacks",
      badge: "",
    ...
    /* ── Sip & Chill Drinks (shopId 3) ── */
    {
      id: "iced_coffee|sip_&_chill_drinks",
      name: "Iced Coffee",
      price: 30,
      category: "drinks",
      badge: "",
      rating: 4.8,
      vendor: "Sip & Chill Drinks",
      shopId: 3,
      prepTime: "3 min",
      stock: 20,
      available: true,
      ...
      reviews: [
        {
          name: "Ryan B.",
          stars: 5,
          comment: "Perfect pick-me-up between classes!",
        },
        {
          name: "Sofia D.",
          stars: 4,
          comment: "Really smooth and not too sweet.",
        },
      ],
    },
    {
      id: "coke|sip_&_chill_drinks",
      name: "Coke",
      price: 25,
      category: "drinks",
      badge: "popular",
      ...
      reviews: [
        {
          name: "Mia C.",
          stars: 5,
          comment: "Ice cold and perfectly chilled!",
        },
      ],
    },
    {
      id: "mango_shake|sip_&_chill_drinks",
      name: "Mango Shake",
      price: 35,
      category: "drinks",
      badge: "popular",
      ...
      reviews: [
        { name: "Gab V.", stars: 5, comment: "The best shake on campus!" },
      ],
    },
    {
      id: "milktea|sip_&_chill_drinks",
      name: "Milk Tea",
      price: 45,
      category: "drinks",
      badge: "",
    ...
    {
      id: "calamansi_juice|sip_&_chill_drinks",
    ...
    {
      id: "halo_halo|sweet_tooth_desserts",
      name: "Halo-Halo",
      price: 55,
      category: "desserts",
      badge: "popular",
      rating: 4.8,
      vendor: "Sweet Tooth Desserts",
      shopId: 4,
      prepTime: "5 min",
      stock: 15,
      available: true,
      ...
      reviews: [
        {
          name: "Nina P.",
          stars: 5,
          comment: "SOBRANG SARAP. Best halo-halo sa campus!",
        },
      ],
    },
    {
      id: "leche_flan|sweet_tooth_desserts",
      name: "Leche Flan",
      price: 35,
      category: "desserts",
      badge: "",
    ...
    {
      id: "strawberry_dessert|sweet_tooth_desserts",
    ...
    {
      id: "bibingka|native_delights",
      name: "Bibingka",
      price: 40,
      category: "snacks",
      badge: "new",
      rating: 4.8,
      vendor: "Native Delights",
      shopId: 12,
      prepTime: "10 min",
      stock: 10,
      available: true,
      ...
      reviews: [
        { name: "Lola E.", stars: 5, comment: "Lutong bahay na sarap!" },
      ],
    },
    {
      id: "mango_float|native_delights",
      name: "Mango Float",
      price: 50,
      category: "desserts",
      badge: "",
      ...
      reviews: [
        { name: "Tin M.", stars: 5, comment: "Always a crowd favorite!" },
      ],
    },

    /* ── The Gourmet Grill (shopId 11) ── */
    {
      id: "spicy_chicken_fillet|the_gourmet_grill",
      name: "Spicy Chicken Fillet",
      price: 45,
      category: "meals",
      badge: "",
      rating: 4.6,
      vendor: "The Gourmet Grill",
      shopId: 11,
      prepTime: "12 min",
      stock: 12,
      available: true,
    ...
    {
      id: "pizza|campus_pizza_hub",
      name: "Campus Pizza",
      price: 65,
      category: "meals",
      badge: "popular",
      rating: 4.4,
      vendor: "Campus Pizza Hub",
      shopId: 6,
      prepTime: "15 min",
      stock: 10,
      available: true,
    ...
    },
    {
      ...
      status: "rejected",
      rejectReason:
        "Image quality is too low. Please provide a clearer photo of the actual dish.",
      img: "../../images/burger.avif",
...
function initDefaultShops() {
  ...
  const defaults = [
    {
      id: 1,
      name: "Mang Tino's Canteen",
      category: "Meals",
      img: "../../images/silog.avif",
      rating: 4.5,
      loc: "Canteen 1 Hall",
      lat: 6.91243320596896,
      lng: 122.06345799098618,
      type: "canteen",
    },
    {
      id: 2,
      ...
      img: "../../images/kwek.jpg",
      rating: 4.7,
      loc: "Science Hall Entrance",
      lat: 6.913187183190812,
      lng: 122.06339479576178,
      type: "canteen",
    },
    {
      id: 3,
      name: "Sip & Chill Drinks",
      category: "Drinks",
      img: "../../images/milktea.avif",
      rating: 4.8,
      loc: "Beside University Pond",
      lat: 6.913773971170068,
      lng: 122.06165556183369,
      type: "canteen",
    },
    {
      id: 4,
      ...
      img: "../../images/halo.avif",
      rating: 4.6,
      loc: "Engineering Bldg G/F",
      lat: 6.913552464390463,
      lng: 122.0608910942802,
      type: "canteen",
    },
    {
      id: 5,
      name: "Green Bowl — Healthy Eats",
      category: "Healthy",
      img: "../../images/pancit.avif",
      rating: 4.9,
      loc: "College of Education Area",
      lat: 6.912850720564993,
      lng: 122.06175222757005,
      type: "vendor",
    },
    {
      id: 6,
      ...
      img: "../../images/pizza.avif",
      rating: 4.4,
      loc: "Near Admin Building",
      lat: 6.912861371406072,
      lng: 122.06177569689841,
      type: "canteen",
    },
    {
      id: 7,
      ...
      rating: 4.3,
      loc: "Library Lobby",
      lat: 6.912876016312175,
      lng: 122.06179514291333,
      type: "canteen",
    },
    {
      id: 8,
      ...
      rating: 4.2,
      loc: "Open Court Area",
      lat: 6.912892658250371,
      lng: 122.06185012819688,
      type: "vendor",
    },
    {
      id: 9,
      ...
      rating: 4.1,
      loc: "Main Gate Side",
      lat: 6.912905971800495,
      lng: 122.06186018648046,
      type: "canteen",
    },
    {
      id: 10,
      ...
      rating: 4.6,
      loc: "Near Gymnasium",
      lat: 6.912921282382685,
      lng: 122.06187359752525,
      type: "canteen",
    },
    {
      id: 11,
      ...
      img: "../../images/spciy.jpg",
      rating: 4.4,
      loc: "College of Engineering",
      lat: 6.912933264577098,
      lng: 122.0618937140924,
      type: "canteen",
    },
    {
      id: 12,
      name: "Native Delights",
      category: "Snacks",
      img: "../../images/bibingka.jpg",
      rating: 4.7,
      loc: "Arts & Science Building",
      lat: 6.912963020964882,
      lng: 122.061914844922,
      type: "vendor",
    },
  ];
...
(function seedExamples() {
  ...
  const examples = [
    ...
    },
    {
      ...
      status: "rejected",
      rejectReason:
        "Application rejected. This item is classified as unhealthy due to excessive oil usage and lack of nutritional balance. The University's food policy restricts deep-fried items without healthier side options. Please submit a revised menu with more nutritious ingredients.",
      img: "../../images/burger.avif",
      desc: "Breaded fish fillet with tartar sauce.",
      ingredients: ["Fish", "Breadcrumbs", "Tartar sauce"],
      reviews: [],
  ...
  if (changed)
    localStorage.setItem("wm_eat_su_menu", JSON.stringify(currentMenu));
})();
