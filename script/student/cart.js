...
function initDefaultMenu() {
  ...
  const defaults = [
    ...
    {
      id: "iced_coffee|sip_&_chill_beverages",
      name: "Iced Coffee",
      price: 30,
      category: "drinks",
      badge: "",
      rating: 4.8,
      vendor: "Sip & Chill Beverages",
      shopId: 3,
      prepTime: "3 min",
      stock: 20,
      available: true,
    ...
    {
      id: "mango_shake|sip_&_chill_beverages",
      name: "Mango Shake",
      price: 35,
      category: "drinks",
      badge: "popular",
    ...
    {
      id: "milktea|sip_&_chill_beverages",
      name: "Milk Tea",
      price: 45,
      category: "drinks",
      badge: "",
    ...
    {
      id: "gulaman|sip_&_chill_beverages",
      name: "Gulaman Drink",
      price: 15,
      category: "drinks",
      badge: "",
    ...
    {
      id: "calamansi_juice|sip_&_chill_beverages",
    ...
    {
      id: "juice|sip_&_chill_beverages",
      name: "Fruit Juice",
      price: 20,
      category: "drinks",
      badge: "",
    ...
    {
      id: "shake|sip_&_chill_beverages",
      name: "Fruit Shake",
      price: 30,
      category: "drinks",
      badge: "",
