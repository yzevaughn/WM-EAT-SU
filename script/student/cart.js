/**
 * cart.js â€” Shared localStorage data module for WM EAT SU
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   MENU  (vendor â†” student browse sync)
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
function initDefaultMenu() {
  ...
  const defaults = [
    /* â”€â”€ Mang Tino's Canteen (shopId 1) â”€â”€ */
    {
      ...
      prepTime: "8 min", stock: 15, available: true,
    ...
    },
    {
      ...
      vendor: "Mang Tino's Canteen", shopId: 1,
      prepTime: "5 min", stock: 50, available: true,
    ...
    },
    {
      ...
      vendor: "Mang Tino's Canteen", shopId: 1,
      prepTime: "3 min", stock: 20, available: true,
    ...
    },
    {
      ...
      vendor: "Mang Tino's Canteen", shopId: 1,
      prepTime: "10 min", stock: 25, available: true,
      img: "../../images/silog.avif",
      desc: "Filipino breakfast favorite â€” sinangag (garlic fried rice) and itlog (egg) with your choice of meat.",
    ...
    },
    {
      ...
      vendor: "Mang Tino's Canteen", shopId: 1,
      prepTime: "8 min", stock: 18, available: true,
    ...
    /* â”€â”€ Street Bites Corner (shopId 2) â”€â”€ */
    {
      ...
      prepTime: "6 min", stock: 30, available: true,
    ...
    },
    {
      ...
      vendor: "Street Bites Corner", shopId: 2,
      prepTime: "7 min", stock: 3, available: true,
    ...
    },
    {
      ...
      vendor: "Street Bites Corner", shopId: 2,
      prepTime: "2 min", stock: 40, available: true,
      img: "../../images/kwek.jpg",
    ...
    },
    {
      ...
      vendor: "Street Bites Corner", shopId: 2,
      prepTime: "1 min", stock: 60, available: true,
    ...
    /* â”€â”€ Sip & Chill Beverages (shopId 3) â”€â”€ */
    {
    ...
    },
    {
      ...
      vendor: "Sip & Chill Beverages", shopId: 3,
      prepTime: "1 min", stock: 50, available: true,
      img: "../../images/coke.png",
    ...
    },
    {
      ...
      category: "drinks", badge: "popular", rating: 4.9,
      vendor: "Sip & Chill Beverages", shopId: 3,
      prepTime: "5 min", stock: 25, available: true,
    ...
    },
    {
      ...
      vendor: "Sip & Chill Beverages", shopId: 3,
      prepTime: "5 min", stock: 18, available: true,
    ...
    },
    {
      ...
      vendor: "Sip & Chill Beverages", shopId: 3,
      prepTime: "2 min", stock: 35, available: true,
    ...
    },
    {
      ...
      vendor: "Sip & Chill Beverages", shopId: 3,
      prepTime: "3 min", stock: 30, available: true,
      img: "../../images/calamnsi-juice.avif",
      desc: "Fresh-squeezed calamansi juice â€” naturally tangy and refreshing.",
    ...
    },
    {
      ...
      desc: "Chilled fruit juice blend â€” sweet and vitamin-rich.",
    ...
    },
    {
      ...
      vendor: "Sip & Chill Beverages", shopId: 3,
      prepTime: "4 min", stock: 22, available: true,
    ...
    /* â”€â”€ Sweet Tooth Desserts (shopId 4) â”€â”€ */
    {
      ...
      prepTime: "5 min", stock: 15, available: true,
    ...
    },
    {
      ...
      vendor: "Sweet Tooth Desserts", shopId: 4,
      prepTime: "2 min", stock: 12, available: true,
    ...
    },
    {
      ...
      vendor: "Sweet Tooth Desserts", shopId: 4,
      prepTime: "4 min", stock: 10, available: true,
    ...
    },
    {
      ...
      vendor: "Native Delights", shopId: 12,
      prepTime: "3 min", stock: 8, available: true,
    ...
    /* â”€â”€ The Gourmet Grill (shopId 11) â”€â”€ */
    {
      ...
      prepTime: "12 min", stock: 12, available: true,
    ...
    /* â”€â”€ Campus Pizza Hub (shopId 6) â”€â”€ */
    {
      ...
      prepTime: "15 min", stock: 10, available: true,
...
function initDefaultShops() {
  ...
  const defaults = [
    ...
    { id:5,  name:"Green Bowl â€” Healthy Eats", category:"Healthy",  img:"../../images/pancit.avif",     rating:4.9, loc:"College of Education Area",lat:6.912850720564993, lng:122.06175222757005, type:"vendor"  },
...
/** Format an ISO date string as "Mon D, YYYY Â· HH:MM AM/PM". */
...
/* â”€â”€ Auto-seed on every page that loads this module â”€â”€ */
initDefaultMenu();
initDefaultShops();
