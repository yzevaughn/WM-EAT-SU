...
window.onload = function () {
  ...
  if (savedMobile) {
    const el = document.getElementById("mobileDisp");
    if (el) el.textContent = savedMobile;
  }
...
function verifyOTP(e) {
  ...
  setTimeout(() => {
    // For Outsiders, we might want to redirect to a success page that doesn't mention document review
...
function resendCode() {
  ...
  startCD(60);
  showGA("A new code has been sent to your mobile number.", "ok");
